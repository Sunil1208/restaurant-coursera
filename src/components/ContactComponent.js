...
class Contact  extends Component {
    ...
    validate(firstname,lastname,telnum,email){
        ...
        const reg = /^\d+$/;    //regular expression which says string of character should be all numbers and nothing else
        if(this.state.touched.telnum && !reg.test(telnum)){
            errors.telnum = 'Tel. number should only contain numbers'
        } else if(this.state.touched.telnum && telnum.length<12){
            errors.telnum = 'Tel. number should not be less than 12 digits'
        } else if(this.state.touched.telnum && telnum.length >12){
            errors.telnum = 'Tel. number should not be greater than 12 digits'
        }

        //checking every character wether there is '@' sign present or not and it's count is not less than 1 and not more than 1.
